...
const wooStructer = async ({ product_href }) => {
  var product_arr = [];
  // fetch product info
  ...
  if (product_variations) {
    ...
    for (let variation of product_variations) {
      ...
      product_arr.push({
        ...
        attribute_3_values:
          variation?.attributes[Object.keys(variation?.attributes)[2]] || "",
      });
    }
  } else {
...
var arrURL = [
  "https://nemvanthanh.vn/san-pham/nem-lo-xo-ruby/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-segovia/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-green-sleep-gap/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-unique/",
  "https://nemvanthanh.vn/san-pham/nem-lo-xo-comfy-gap-2-gap-3/",
  "https://nemvanthanh.vn/san-pham/nem-lo-xo-perfect/",
  "https://nemvanthanh.vn/san-pham/nem-lo-xo-harmony/",
  "https://nemvanthanh.vn/san-pham/nem-lo-xo-diamond/",
  "https://nemvanthanh.vn/san-pham/nem-mousse-queen-foam-5n-vai-cotton/",
  "https://nemvanthanh.vn/san-pham/nem-mousse-queen-foam-5n-vai-tricat/",
  "https://nemvanthanh.vn/san-pham/nem-mousse-queen-foam-10n/",
  "https://nemvanthanh.vn/san-pham/nem-gon-fantasy-thang-vai-tricat/",
  "https://nemvanthanh.vn/san-pham/nem-gon-fantasy-thang-vai-cotton/",
  "https://nemvanthanh.vn/san-pham/nem-gon-fantasy-gap-3-vai-tricat/",
  "https://nemvanthanh.vn/san-pham/nem-gon-ep-fantasy-gap-3-vai-cotton/",
  "https://nemvanthanh.vn/san-pham/nem-gon-fantasy-gap-3-vai-gam/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-gon-ep-ultra-care-gap-1c2g/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-mousse-ep-venus-gap-vai-gam/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-gon-ep-ultra-care-gap-3c7g/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-mousse-ep-venus-gap-vai-cotton/",
  "https://nemvanthanh.vn/san-pham/nem-cao-su-gon-ep-ultra-care-thang-3c7g/",
];
var url = "https://nemvanthanh.vn/san-pham/nem-cao-su-unique/";

// wooStructer({ product_href: url }).then((data) => {
//   // convert object -> json
//   var json = JSON.stringify(data);
//   // export json file
//   fs.writeFile("add-more.json", json, "utf8", (error) => {
//     if (error) throw error; // if error
//     console.log("+ add-more -> OK\n-> Converting to .csv file ...");
//   });
// });

async function doCrawl({ product_href }) {
  wooStructer({ product_href }).then((data) => {
    // convert object -> json
    var json = JSON.stringify(data);
    // export json file
    fs.appendFile(
      "Nem-Van-Thanh_Woocommerce-UPDATED.json",
      json,
      "utf8",
      (error) => {
        if (error) throw error; // if error
        console.log(
          "+ Nem-Van-Thanh_Woocommerce-UPDATED.json -> OK\n-> Converting to .csv file ..."
        );
      }
    );
  });
...
for (var product_href of arrURL) {
  console.log(product_href);
  await doCrawl({ product_href }).then(() => {
    console.log(product_href + " -> OK");
  });
}
